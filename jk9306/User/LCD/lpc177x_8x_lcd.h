...
//#define C_GLCD_H_SIZE           0
//#define C_GLCD_V_SIZE           0
...
//显示16的英文字符渐变
void WriteString_16_Shade(uint16_t x0,uint16_t y0,const char *pcStr,uint8_t mode,uint8_t red,uint8_t green,uint8_t blue,uint8_t big_small,uint8_t colorflag);
//画渐变矩形
